...
export const spots: Spot[] = [
  ...
  { id: 'mirador-sao-lourenco', category: 'viewpoint', free: true, mapQuery: 'Miradouro de São Lourenço, Porto, Portugal', day: 'fri', image: "https://thumb.wikimedia.org/wikipedia/commons/thumb/3/3d/Porto%2C_vista_da_S%C3%A9_do_Porto_%283%29.jpg/500px-Porto%2C_vista_da_S%C3%A9_do_Porto_%283%29.jpg"},
  ...
  { id: 'camara', category: 'sight', free: true, mapQuery: 'Câmara Municipal do Porto, Portugal', day: 'fri', image: "https://thumb.wikimedia.org/wikipedia/commons/thumb/d/d6/Pa%C3%A7os_do_Concelho_do_Porto_por_Rodrigo_Tetsuo_Argenton.jpg/500px-Pa%C3%A7os_do_Concelho_do_Porto_por_Rodrigo_Tetsuo_Argenton.jpg"},
  ...
  { id: 'serralves', category: 'museum', free: false, mapQuery: 'Serralves, Porto, Portugal', day: 'sat', image: "https://thumb.wikimedia.org/wikipedia/commons/thumb/f/fe/Funda%C3%A7%C3%A3o_serralves_%2839740223333%29.jpg/500px-Funda%C3%A7%C3%A3o_serralves_%2839740223333%29.jpg"},
